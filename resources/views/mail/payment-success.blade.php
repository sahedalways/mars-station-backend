<x-mail.layout>
    ...
    <h1 style="margin: 0 0 8px; color: #111827; font-size: 26px; line-height: 32px; font-weight: 700; text-align: center;">
        Payment <span style="color: #15803d;">Successful</span>
    </h1>
    ...
    <p style="margin: 0 0 6px; color: #374151; font-size: 14px; line-height: 22px;">
        We have received your payment for the agreement listed below.
    </p>
    <p style="margin: 0 0 6px; color: #374151; font-size: 14px; line-height: 22px;">
        Your services are now active and you can proceed with confidence.
    </p>
    ...
    <div style="background: #f0fdf4; border-radius: 12px; padding: 20px; margin-bottom: 20px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
            ...
            <tr>
                ...
                <td style="padding: 8px 0; vertical-align: top;">
                    <p style="margin: 0; color: #6b7280; font-size: 12px;">Paid On</p>
                    <p style="margin: 2px 0 0; color: #111827; font-size: 13px; font-weight: 600;">
                        {{ ($payment->paid_at ?? now())->format('M d, Y h:i A') }}
                    </p>
                </td>
                <td style="padding: 8px 0; vertical-align: top;">
                    <p style="margin: 0; color: #6b7280; font-size: 12px;">Payment Status</p>
                    <p style="margin: 4px 0 0;">
                        <span style="display: inline-block; padding: 3px 12px; background: #dcfce7; color: #15803d; border-radius: 6px; font-size: 12px; font-weight: 600;">
                            Paid
                        </span>
                    </p>
                </td>
            ...
            <tr>
                ...
                <td style="vertical-align: top;">
                    ...
                    <p style="margin: 0; color: #374151; font-size: 13px; line-height: 20px;">
                        You can view your receipt and agreement details anytime using the link below.
                        @if(isset($payment->transaction_id))
                            <br><span style="font-size: 11px; color: #6b7280;">Transaction ID: {{ $payment->transaction_id }}</span>
                        @endif
                    </p>
                </td>
            </tr>
    ...
    <p style="margin: 0 0 24px; color: #6b7280; font-size: 13px; line-height: 20px; text-align: center;">
        Click the button above to view your receipt and download your agreement.
    </p>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td style="vertical-align: top;">
                    ...
                    <a href="{{ $link->publicUrl() }}" style="color: #15803d; font-size: 12px; word-break: break-all; text-decoration: underline;">
                        {{ $link->publicUrl() }}
                    </a>
                </td>
            </tr>
